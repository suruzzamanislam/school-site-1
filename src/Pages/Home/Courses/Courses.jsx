...
const Courses = () => {
  return (
    <div
      id="Courses"
      className="bg-[#F2F2F2] px-3 md:px-16 lg:px-24  py-12 space-y-3"
    >
      <h1 className="text-4xl font-semibold">Our Courses</h1>
      <div className="grid grid-cols-2  lg:grid-cols-4 gap-y-4 gap-x-2 md:gap-x-10">
        <div className="course_box hover:translate-y-3 duration-300 bg-white relative cursor-pointer">
          ...
          <div className="px-5 py-3 md:py-10 space-y-2">
            <p className="text-2xl font-medium">Biochemistry</p>
            <p className="text-lg">When you unknown printer took a galley...</p>
          </div>
        ...
        <div className="course_box hover:translate-y-3 duration-300 cursor-pointer bg-white relative">
          ...
          <div className="px-5 py-3 md:py-10 space-y-2">
            <p className="text-2xl font-medium">Human Sciences</p>
            <p className="text-lg">When you unknown printer took a galley...</p>
          </div>
          <div className="absolute top-[47%] right-3 w-10 h-10 bg-[#534C49] text-white rounded-full flex justify-center items-center plus_icon duration-200">
            <FaPlus></FaPlus>
        ...
        <div className="course_box hover:translate-y-3 duration-300 cursor-pointer bg-white relative">
          ...
          <div className="px-5 py-3 md:py-10 space-y-2">
            <p className="text-2xl font-medium">Earth Sciences</p>
            <p className="text-lg">When you unknown printer took a galley...</p>
          </div>
          <div className="absolute top-[47%] right-3 w-10 h-10 bg-[#534C49] text-white rounded-full flex justify-center items-center plus_icon duration-200">
            <FaPlus></FaPlus>
